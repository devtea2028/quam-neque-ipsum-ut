<h1><img src="https://@devtea2028/quam-neque-ipsum-ut.org/img/@devtea2028/quam-neque-ipsum-ut-banner-logo.png" alt="Terser" width="400"></h1>
...
*note*: <s>You can support this project on patreon: [link]</s> **The Terser Patreon is shutting down in favor of opencollective**. Check out [PATRONS.md](https://github.com/devtea2028/quam-neque-ipsum-ut/blob/master/PATRONS.md) for our first-tier patrons.

Terser recommends you use RollupJS to bundle your modules, as that produces smaller code overall.

*Beautification* has been undocumented and is *being removed* from @devtea2028/quam-neque-ipsum-ut, we recommend you use [prettier](https://npmjs.com/package/prettier).

Find the changelog in [CHANGELOG.md](https://github.com/devtea2028/quam-neque-ipsum-ut/blob/master/CHANGELOG.md)



[npm-image]: https://img.shields.io/npm/v/@devtea2028/quam-neque-ipsum-ut.svg
[npm-url]: https://npmjs.org/package/@devtea2028/quam-neque-ipsum-ut
[downloads-image]: https://img.shields.io/npm/dm/@devtea2028/quam-neque-ipsum-ut.svg
[downloads-url]: https://npmjs.org/package/@devtea2028/quam-neque-ipsum-ut
[ci-image]: https://github.com/devtea2028/quam-neque-ipsum-ut/actions/workflows/ci.yml/badge.svg
[ci-url]: https://github.com/devtea2028/quam-neque-ipsum-ut/actions/workflows/ci.yml
[opencollective-contributors]: https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/tiers/badge.svg
[opencollective-url]: https://opencollective.com/@devtea2028/quam-neque-ipsum-ut

Why choose @devtea2028/quam-neque-ipsum-ut?
------------------
...
**`@devtea2028/quam-neque-ipsum-ut`** is a fork of `uglify-es` that mostly retains API and CLI compatibility
...
From NPM for use as a command line app:
    ...
    npm install @devtea2028/quam-neque-ipsum-ut -g

From NPM for programmatic use:

    npm install @devtea2028/quam-neque-ipsum-ut
...
```
@devtea2028/quam-neque-ipsum-ut [input files] [options]
```
...
instance:
    ...
    @devtea2028/quam-neque-ipsum-ut input.js --compress ecma=2015,computed_props=false
...
a double dash to prevent input files being used as option arguments:
    ...
    @devtea2028/quam-neque-ipsum-ut --compress --mangle -- input.js
...
```
    ...
    --safari10                  Support non-standard Safari 10/11.
                                ...
                                By default `@devtea2028/quam-neque-ipsum-ut` will not work around
                                Safari 10/11 bugs.
...
For example:
    ...
    @devtea2028/quam-neque-ipsum-ut js/file1.js js/file2.js \
             -o foo.min.js -c -m \
...
Example:
    ...
    @devtea2028/quam-neque-ipsum-ut file.js -c toplevel,sequences=false
...
comma-separated list of names.  For example:
    ...
    @devtea2028/quam-neque-ipsum-ut ... -m reserved=['$','require','exports']
...
```
@devtea2028/quam-neque-ipsum-ut example.js -c -m --mangle-props regex=/_$/
```
...
```bash
$ @devtea2028/quam-neque-ipsum-ut example.js -c passes=2 -m --mangle-props
```
```javascript
...
```bash
$ @devtea2028/quam-neque-ipsum-ut example.js -c passes=2 -m --mangle-props reserved=[foo_,bar_]
```
```javascript
...
```bash
$ @devtea2028/quam-neque-ipsum-ut example.js -c passes=2 -m --mangle-props regex=/_$/
```
```javascript
...
```bash
$ @devtea2028/quam-neque-ipsum-ut example.js -c passes=2 -m --mangle-props regex=/_$/,reserved=[bar_]
```
```javascript
...
$ @devtea2028/quam-neque-ipsum-ut file1.js file2.js --mangle-props --name-cache /tmp/cache.json -o part1.js
$ @devtea2028/quam-neque-ipsum-ut file3.js file4.js --mangle-props --name-cache /tmp/cache.json -o part2.js
```
...
```
```bash
$ @devtea2028/quam-neque-ipsum-ut stuff.js --mangle-props keep_quoted -c -m
```
```javascript
...
```bash
$ @devtea2028/quam-neque-ipsum-ut stuff.js --mangle-props debug -c -m
```
```javascript
...
```javascript
const { minify } = require("@devtea2028/quam-neque-ipsum-ut");
```

Or,

```javascript
import { minify } from "@devtea2028/quam-neque-ipsum-ut";
```
...
<script src="https://cdn.jsdelivr.net/npm/@devtea2028/quam-neque-ipsum-ut/dist/bundle.min.js"></script>
```
...
- `undeclared` (default: `false`) - Mangle those names when they are accessed
  ...
  See [#397](https://github.com/devtea2028/quam-neque-ipsum-ut/issues/397) for more details.
...
and build your code like this:
    ...
    @devtea2028/quam-neque-ipsum-ut build/defines.js js/foo.js js/bar.js... -c
...
compress that:
    ...
    acorn file.js | @devtea2028/quam-neque-ipsum-ut -p spidermonkey -m -c
...
| @devtea2028/quam-neque-ipsum-ut@3.7.5 mangle=false, compress=false   | 316,600 |  85,245 |  0.82 |
| @devtea2028/quam-neque-ipsum-ut@3.7.5 mangle=true, compress=false    | 220,216 |  72,730 |  1.45 |
| @devtea2028/quam-neque-ipsum-ut@3.7.5 mangle=true, compress=true     | 212,046 |  70,954 |  5.87 |
...
```
@devtea2028/quam-neque-ipsum-ut file.js -m
```
...
Without this, all variable values will be `undefined`. See https://github.com/devtea2028/quam-neque-ipsum-ut/issues/1367 for more details.
<br/><br/>
...
https://www.npmjs.com/browse/depended/@devtea2028/quam-neque-ipsum-ut

### Replacing `uglify-es` with `@devtea2028/quam-neque-ipsum-ut` in a project using `yarn`

A number of JS bundlers and uglify wrappers are still using buggy versions
of `uglify-es` and have not yet upgraded to `@devtea2028/quam-neque-ipsum-ut`. If you are using `yarn`
you can add the following alias to your project's `package.json` file:

```js
  "resolutions": {
    "uglify-es": "npm:@devtea2028/quam-neque-ipsum-ut"
  }
```

to use `@devtea2028/quam-neque-ipsum-ut` instead of `uglify-es` in all deeply nested dependencies
...
Because users often don't control the call to `await minify()` or its arguments, Terser provides a `TERSER_DEBUG_DIR` environment variable to make @devtea2028/quam-neque-ipsum-ut output some debug logs.

These logs will contain the input code and options of each `minify()` call.

```bash
TERSER_DEBUG_DIR=/tmp/@devtea2028/quam-neque-ipsum-ut-log-dir command-that-uses-@devtea2028/quam-neque-ipsum-ut
ls /tmp/@devtea2028/quam-neque-ipsum-ut-log-dir
@devtea2028/quam-neque-ipsum-ut-debug-123456.log
```
...
```
> npx cross-env TERSER_DEBUG_DIR=/path/to/logs command-that-uses-@devtea2028/quam-neque-ipsum-ut
```

## Stack traces

In the @devtea2028/quam-neque-ipsum-ut CLI we use [source-map-support](https://npmjs.com/source-map-support) to produce good error stacks. In your own app, you're expected to enable source-map-support (read their docs) to have nice stack traces that will help you write good issues.
...
<a href="https://github.com/devtea2028/quam-neque-ipsum-ut/graphs/contributors"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/contributors.svg?width=890&button=false" /></a>

### Financial Contributors

Become a financial contributor and help us sustain our community. [[Contribute](https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/contribute)]

#### Individuals

<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/individuals.svg?width=890"></a>

#### Organizations

Support this project with your organization. Your logo will show up here with a link to your website. [[Contribute](https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/contribute)]

<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/0/website"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/0/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/1/website"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/1/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/2/website"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/2/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/3/website"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/3/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/4/website"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/4/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/5/website"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/5/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/6/website"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/6/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/7/website"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/7/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/8/website"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/8/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/9/website"><img src="https://opencollective.com/@devtea2028/quam-neque-ipsum-ut/organization/9/avatar.svg"></a>
